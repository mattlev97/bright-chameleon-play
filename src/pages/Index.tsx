...
import { Calendar, Trash2, Wallet, TrendingUp, Target, Repeat, AlertCircle, CheckCircle2 } from 'lucide-react';
              ...
              data.expenses.map((expense) => {
                ...
                return (
                  <div 
                    ...
                    className="bg-white dark:bg-[#1A1830] p-4 rounded-[16px] border-l-4 flex items-center justify-between shadow-sm active:scale-[0.98] transition-all cursor-pointer"
                  ...
                  >
                    ...
                    <div className="flex flex-col items-end gap-2">
                      ...
                      <button onClick={(e) => { e.stopPropagation(); deleteExpense(expense.id); }} className="p-1.5 text-slate-300 hover:text-red-400 transition-colors"><Trash2 size={14} /></button>
                    </div>
                  </div>
                );
              })
